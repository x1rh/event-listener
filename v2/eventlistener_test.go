...
type TokenFactoryLogHandler struct {
	AppCtx AppCtx 

	HandleLog   LogHandleFunc
	HandleEvent LogEventHandleFunc
}

func (h *TokenFactoryLogHandler) EventHandler() LogEventHandleFunc {
	return h.HandleEvent
}

func (h *TokenFactoryLogHandler) LogHandler() LogHandleFunc {
	return h.HandleLog
}
...
func NewTokenFactoryEventListener() (*EventListener, error) {
	...
	tokenFactory.LogHandler = &TokenFactoryLogHandler{
		AppCtx: AppCtx{},
		HandleLog: ,
		HandleEvent: ,
	}
